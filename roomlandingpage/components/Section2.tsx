...
const Section2 = () => {
  return (
    <div className='flex flex-col sm:flex-row max-h-[266px]'>
      <img src='image-about-dark.jpg' className='h-max-[266px]' alt="Dark chairs with Table"></img>
      <section className='flex flex-col justify-center space-y-4 p-8 mx-auto'>
      ...
      <img src='image-about-light.jpg' className='h-max-[266px]' alt="White Chair"></img>
    </div>
  )
}
